...
def main():
    ...
    for result in results:
        print(f"{result['model_name']} - MAE: {result['mae']:.4f}, MSE: {result['mse']:.4f}, R2: {result['r2']:.4f}")
    ...
    print(f"Best model metrics - MAE: {best_model_info['mae']:.4f}, MSE: {best_model_info['mse']:.4f}, R2: {best_model_info['r2']:.4f}")
